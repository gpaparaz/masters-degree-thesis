...
\usepackage[toc, nogroupskip]{glossaries}   % glossario
...
\usepackage{geometry}                   % permette di cambiare i margini della prima pagina
\usepackage{wrapfig}                    % permette di posizionare le immagini a lato